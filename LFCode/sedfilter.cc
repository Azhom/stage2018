  ...
  : sed2_(NULL), sed2init_(NULL)  //  CHECK Pointers initialized to zero - Is this correct ?  Reza  April 2016 
{
    ...
    bool isSetZero = true; // this needs to be checked
    int nComments = 0;
	sed_.ReadXYFromFile(fname, xmin, xmax, npt, nComments, isSetZero);  // FH: fname instead of filename 
                                                      ...
                                                      bool zero_outside,int npt)
{
    ...
    ReadXYFromFile(fname,xmin,xmax,npt,nComments,zero_outside);
};
